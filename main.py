...
def chatHistory():
    ...
    for chat in friends[read_for].chats:
        if chat.sent_by_me:
            ...
            print("[%s] [%s] , %s %s: %s" % (
            chat.time.strftime("%d %B %Y"), Fore.BLUE + chat.time.strftime(" %H:%M:%S"), Fore.RED + spy.name,
            Fore.BLACK + "said : ", chat.message))
            # print ("[%s] %s %s: %s" % (chat.time.strftime("%d %B %Y"),    Fore.GREEN + spy.name              ,    Fore.BLACK + 'said:',   chat.message))
        else:
            print("[%s] [%s] , %s %s: %s" % (
                chat.time.strftime("%d %B %Y"), Fore.BLUE + chat.time.strftime(" %H:%M:%S"),
                Fore.RED + friends[read_for].name,
                Fore.BLACK + "said : ", chat.message))
